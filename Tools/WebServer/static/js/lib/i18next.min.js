!(function (t, e) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define(e)
      : ((t =
          'undefined' != typeof globalThis ? globalThis : t || self).i18next =
          e());
})(this, function () {
  'use strict';
  const t = {
  ...
  class e {
    ...
    forward(t, e, s, i) {
      return i && !this.debug
        ? null
        : ('string' == typeof t[0] && (t[0] = `${s}${this.prefix} ${t[0]}`),
          this.logger[e](t));
    }
    create(t) {
  ...
  class i {
    ...
    off(t, e) {
      this.observers[t] &&
        (e ? this.observers[t].delete(e) : delete this.observers[t]);
    }
    emit(t) {
      for (
  ...
  function l(t, e, s) {
    ...
    for (; void 0 === l.obj && r.length; )
      ((o = `${r[r.length - 1]}.${o}`),
        ...
        (l = a(t, r, Object)),
        l && l.obj && void 0 !== l.obj[`${l.k}.${o}`] && (l.obj = void 0));
    l.obj[`${l.k}.${o}`] = s;
  }
  function u(t, e) {
  ...
  function m(t, e) {
    ...
    for (let t = 0; t < i.length; ) {
      ...
      for (let r = t; r < i.length; ++r)
        if ((r !== t && (o += s), (o += i[r]), (e = n[o]), void 0 !== e)) {
          if (
  ...
  class v extends i {
    ...
    getResource(t, e, s) {
      ...
      return (
        !a &&
          ...
          !s &&
          t.indexOf('.') > -1 &&
          ((t = r[0]), (e = r[1]), (s = r.slice(2).join('.'))),
        a || !o || 'string' != typeof s
          ? a
          : m(this.data && this.data[t] && this.data[t][e], s, n)
      );
    }
    addResource(t, e, s, i) {
      let n =
        arguments.length > 4 && void 0 !== arguments[4]
          ...
          : { silent: !1 };
      const o =
        void 0 !== n.keySeparator ? n.keySeparator : this.options.keySeparator;
      let r = [t, e];
      (s && (r = r.concat(o ? s.split(o) : s)),
        t.indexOf('.') > -1 && ((r = t.split('.')), (i = e), (e = r[1])),
        this.addNamespaces(e),
        l(this.data, r, i),
        n.silent || this.emit('added', t, e, s, i));
    }
    addResources(t, e, s) {
      let i =
        arguments.length > 3 && void 0 !== arguments[3]
          ...
          : { silent: !1 };
      for (const i in s)
        ('string' == typeof s[i] || Array.isArray(s[i])) &&
          this.addResource(t, e, i, s[i], { silent: !0 });
    ...
    addResourceBundle(t, e, s, i, n) {
      let o =
        ...
        r = [t, e];
      (t.indexOf('.') > -1 &&
        ((r = t.split('.')), (i = s), (s = e), (e = r[1])),
        this.addNamespaces(e));
      let a = u(this.data, r) || {};
      (o.skipCopy || (s = JSON.parse(JSON.stringify(s))),
        i ? h(a, s, n) : (a = { ...a, ...s }),
        l(this.data, r, a),
        o.silent || this.emit('added', t, e, s));
    }
  ...
  class S extends i {
    ...
    extractFromKey(t, e) {
      let s =
        void 0 !== e.nsSeparator ? e.nsSeparator : this.options.nsSeparator;
      void 0 === s && (s = ':');
      const i =
        void 0 !== e.keySeparator ? e.keySeparator : this.options.keySeparator;
      ...
      if (o && !r) {
        ...
        const o = t.split(s);
        ((s !== i || (s === i && this.options.ns.indexOf(o[0]) > -1)) &&
          (n = o.shift()),
          (t = o.join(i)));
      }
    ...
    translate(t, e, s) {
      ...
      const i =
        ...
        n =
          void 0 !== e.keySeparator
            ? e.keySeparator
            : this.options.keySeparator,
        { key: o, namespaces: r } = this.extractFromKey(t[t.length - 1], e),
        a = r[r.length - 1],
      ...
      let p = h && h.res;
      const c = (h && h.usedKey) || o,
        g = (h && h.exactUsedKey) || o,
      ...
      if (
        ...
        'boolean' != typeof p &&
        'number' != typeof p &&
        ['[object Number]', '[object Function]', '[object RegExp]'].indexOf(d) <
          0 &&
        ...
        if (!e.returnObjects && !this.options.returnObjects) {
          ...
          const t = this.options.returnedObjectHandler
            ? this.options.returnedObjectHandler(c, p, { ...e, ns: r })
            : `key '${o} (${this.language})' returned an object instead of string.`;
          return i
            ? ((h.res = t), (h.usedParams = this.getUsedParamsDetails(e)), h)
            : t;
        }
        if (n) {
          ...
          for (const t in p)
            if (Object.prototype.hasOwnProperty.call(p, t)) {
              const o = `${i}${n}${t}`;
              ((s[t] = this.translate(o, { ...e, joinArrays: !1, ns: r })),
                s[t] === o && (s[t] = p[t]));
            }
          p = s;
        }
      } else if (m && 'string' == typeof f && Array.isArray(p))
        ((p = p.join(f)), p && (p = this.extendTranslation(p, t, e, s)));
      else {
        let i = !1,
          r = !1;
        const u = void 0 !== e.count && 'string' != typeof e.count,
          c = S.hasDefaultValue(e),
          ...
          m =
            (f && e[`defaultValue${this.options.pluralSeparator}zero`]) ||
            e[`defaultValue${g}`] ||
            e[`defaultValue${d}`] ||
            e.defaultValue;
        (!this.isValidLookup(p) && c && ((i = !0), (p = m)),
          this.isValidLookup(p) || ((r = !0), (p = o)));
        const y =
        ...
        if (r || i || v) {
          ...
          let t = [];
          const s = this.languageUtils.getFallbackCodes(
          ...
          const i = (t, s, i) => {
            ...
            (this.options.missingKeyHandler
              ? this.options.missingKeyHandler(t, a, s, n, v, e)
              : this.backendConnector &&
                this.backendConnector.saveMissing &&
                this.backendConnector.saveMissing(t, a, s, n, v, e),
              this.emit('missingKey', t, a, s, p));
          };
            ...
            (this.options.saveMissingPlurals && u
              ? t.forEach((t) => {
                  ...
                  (f &&
                    ...
                    s.indexOf(`${this.options.pluralSeparator}zero`) < 0 &&
                    s.push(`${this.options.pluralSeparator}zero`),
                    s.forEach((s) => {
        ...
        ((p = this.extendTranslation(p, t, e, h, s)),
          r &&
            p === o &&
      ...
      return i
        ? ((h.res = p), (h.usedParams = this.getUsedParamsDetails(e)), h)
        : p;
    }
    extendTranslation(t, e, s, i, n) {
      ...
      if (this.i18nFormat && this.i18nFormat.parse)
        ...
        const r =
          'string' == typeof t &&
          (s && s.interpolation && void 0 !== s.interpolation.skipOnVariables
        ...
        if (
          ...
          (t = this.interpolator.interpolate(t, l, s.lng || this.language, s)),
          r)
        ) {
          const e = t.match(this.interpolator.nestingRegexp);
            ...
            (t = this.interpolator.nest(
              ...
              function () {
                for (
                  ...
                  i[r] = arguments[r];
                return n && n[0] === i[0] && !s.context
                  ? (o.logger.warn(
                      `It seems you are nesting recursively key: ${i[0]} in key: ${e[0]}`,
                    ),
                    null)
                  : o.translate(...i, e);
              },
    ...
    resolve(t) {
      ...
      return (
        ...
        t.forEach((t) => {
          ...
          const a = this.extractFromKey(t, r),
            l = a.key;
          s = l;
          let u = a.namespaces;
          ...
          u.forEach((t) => {
            this.isValidLookup(e) ||
              ...
              !x[`${g[0]}-${t}`] &&
                ...
                ((x[`${g[0]}-${t}`] = !0),
                this.logger.warn(
                  `key "${s}" for languages "${g.join(', ')}" won't get resolved as namespace "${o}" was not yet loaded`,
              ...
              g.forEach((s) => {
                ...
                if (this.i18nFormat && this.i18nFormat.addLookupKeys)
                  this.i18nFormat.addLookupKeys(o, l, s, t, r);
                else {
                  let t;
                  ...
                  if (
                    (h &&
                      ...
                      r.ordinal &&
                        0 === t.indexOf(i) &&
                        o.push(l + t.replace(i, this.options.pluralSeparator)),
                      p && o.push(l + e)),
                    c)
                  ) {
                    ...
                    (o.push(s),
                      h &&
                        ...
                        r.ordinal &&
                          0 === t.indexOf(i) &&
                          o.push(
                            s + t.replace(i, this.options.pluralSeparator),
                          ),
                        p && o.push(s + e)));
                  }
                }
                ...
                for (; (a = o.pop()); )
                  this.isValidLookup(e) ||
                    ((i = a), (e = this.getResource(s, t, a, r)));
              }));
          });
        }),
    ...
    getResource(t, e, s) {
      ...
      return this.i18nFormat && this.i18nFormat.getResource
        ? this.i18nFormat.getResource(t, e, s, i)
        : this.resourceStore.getResource(t, e, s, i);
    }
    getUsedParamsDetails() {
      ...
      let i = s ? t.replace : t;
      if (
        (s && void 0 !== t.count && (i.count = t.count),
        this.options.interpolation.defaultVariables &&
  ...
  class O {
        ...
        return (
          this.options.lowerCaseLng
            ...
            : 2 === s.length
              ? ((s[0] = s[0].toLowerCase()),
                (s[1] = s[1].toUpperCase()),
                e.indexOf(s[1].toLowerCase()) > -1 &&
                  (s[1] = k(s[1].toLowerCase())))
              : 3 === s.length &&
                ((s[0] = s[0].toLowerCase()),
                ...
                e.indexOf(s[1].toLowerCase()) > -1 &&
                  (s[1] = k(s[1].toLowerCase())),
                e.indexOf(s[2].toLowerCase()) > -1 &&
                  (s[2] = k(s[2].toLowerCase()))),
          s.join('-')
        );
      }
        ...
        !e &&
          ...
          t.forEach((t) => {
            ...
            e = this.options.supportedLngs.find((t) =>
              t === s
                ? t
                : t.indexOf('-') < 0 && s.indexOf('-') < 0
                  ? void 0
                  : (t.indexOf('-') > 0 &&
                        s.indexOf('-') < 0 &&
                        t.substring(0, t.indexOf('-')) === s) ||
                      (0 === t.indexOf(s) && s.length > 1)
                    ? t
                    : void 0,
            );
          }),
    ...
    getFallbackCodes(t, e) {
      ...
      let s = t[e];
      return (
        s || (s = t[this.getScriptPartFromCode(e)]),
        s || (s = t[this.formatLanguageCode(e)]),
        s || (s = t[this.getLanguagePartFromCode(e)]),
        s || (s = t.default),
        s || []
      );
    }
    toResolveHierarchy(t, e) {
      const s = this.getFallbackCodes(e || this.options.fallbackLng || [], t),
        i = [],
        n = (t) => {
          t &&
      ...
      return (
        'string' == typeof t && (t.indexOf('-') > -1 || t.indexOf('_') > -1)
          ...
          : 'string' == typeof t && n(this.formatLanguageCode(t)),
        s.forEach((t) => {
  ...
  class C {
    constructor(t) {
      ...
      ((this.languageUtils = t),
        ...
        (this.options.compatibilityJSON &&
          !$.includes(this.options.compatibilityJSON)) ||
    ...
    getRule(t) {
      ...
      if (this.shouldUseIntlApi())
        try {
          return new Intl.PluralRules(y('dev' === t ? 'en' : t), {
      ...
      return s
        ? this.shouldUseIntlApi()
          ? s
              ...
              .map(
                (t) =>
                  `${this.options.prepend}${e.ordinal ? `ordinal${this.options.prepend}` : ''}${t}`,
              )
          : s.numbers.map((s) => this.getSuffix(t, s, e))
        : [];
    }
    getSuffix(t, e) {
      let s =
      ...
      return i
        ? this.shouldUseIntlApi()
          ? `${this.options.prepend}${s.ordinal ? `ordinal${this.options.prepend}` : ''}${i.select(e)}`
          : this.getSuffixRetroCompatible(i, e)
  ...
  class j {
    ...
    init() {
      ...
      ((this.escape = void 0 !== e ? e : g),
        ...
        (this.nestingPrefix = c ? p(c) : d || p('$t(')),
    ...
    resetRegExp() {
      const t = (t, e) =>
        t && t.source === e ? ((t.lastIndex = 0), t) : new RegExp(e, 'g');
      ...
      const h = (t) => {
        if (t.indexOf(this.formatSeparator) < 0) {
          ...
          return this.alwaysFormat
            ? this.format(n, void 0, s, { ...i, ...e, interpolationkey: t })
            : n;
        }
        const n = t.split(this.formatSeparator),
          o = n.shift().trim(),
          r = n.join(this.formatSeparator).trim();
        return this.format(
          P(
            e,
            l,
    ...
    nest(t, e) {
      ...
      for (; (s = this.nestingRegexp.exec(t)); ) {
        ...
        if (
          ((i = e(a.call(this, s[1].trim(), n), n)),
          i && s[0] === t && 'string' != typeof i)
        )
          return i;
        ...
        const { formatName: n, formatOptions: o } = (function (t) {
          ...
          if (t.indexOf('(') > -1) {
            ...
            'currency' === e && n.indexOf(':') < 0
              ? s.currency || (s.currency = n.trim())
              : 'relativetime' === e && n.indexOf(':') < 0
                ? s.range || (s.range = n.trim())
                : n.split(';').forEach((t) => {
                    if (t) {
                      const [e, ...i] = t.split(':'),
                        n = i
  ...
  class F extends i {
    ...
    queueLoad(t, e, s, i) {
      ...
      return (
        t.forEach((t) => {
          ...
          (e.forEach((e) => {
            const r = `${t}|${e}`;
            !s.reload && this.store.hasResourceBundle(t, e)
              ? (this.state[r] = 2)
              : this.state[r] < 0 ||
                (1 === this.state[r]
                  ? void 0 === o[r] && (o[r] = !0)
    ...
    loaded(t, e, s) {
      ...
      (e && this.emit('failedLoading', n, o, e),
        s &&
          this.store.addResourceBundle(n, o, s, void 0, void 0, {
            skipCopy: !0,
          }),
        (this.state[t] = e ? -1 : 2));
      const r = {};
    ...
    loadOne(t) {
      ...
      this.read(i, n, 'read', void 0, void 0, (s, o) => {
        (s &&
          this.logger.warn(
            `${e}loading namespace ${n} for language ${i} failed`,
            s,
          ),
          !s &&
            o &&
            this.logger.log(`${e}loaded namespace ${n} for language ${i}`, o),
          this.loaded(t, s, o));
      });
    }
    saveMissing(t, e, s, i, n) {
      ...
      if (
        ...
        this.logger.warn(
          `did not save key "${s}" as the namespace "${e}" was not yet loaded`,
          'This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!',
        );
      else if (null != s && '' !== s) {
        if (this.backend && this.backend.create) {
          const a = { ...o, isUpdate: n },
            l = this.backend.create.bind(this.backend);
          if (l.length < 6)
            try {
              let n;
              ((n = 5 === l.length ? l(t, e, s, i, a) : l(t, e, s, i)),
                n && 'function' == typeof n.then
                  ? n.then((t) => r(null, t)).catch(r)
                  : r(null, n));
            } catch (t) {
              r(t);
            }
  ...
  class U extends i {
    ...
    init() {
      ...
      if (
        ((this.options = { ...o, ...this.options, ...V(e) }),
        'v1' !== this.options.compatibilityAPI &&
          (this.options.interpolation = {
            ...o.interpolation,
            ...this.options.interpolation,
        ...
        ((n.logger = s),
          ...
          (n.interpolator = new j(this.options)),
          (n.utils = {
            hasLoadedNamespace: this.hasLoadedNamespace.bind(this),
          }),
          (n.backendConnector = new F(
          ...
          n.backendConnector.on('*', function (e) {
            for (
              var s = arguments.length, i = new Array(s > 1 ? s - 1 : 0), n = 1;
              n < s;
              n++
            )
              i[n - 1] = arguments[n];
    ...
    loadResources(t) {
      ...
      if (
        ...
        (this.options.preload && this.options.preload.forEach((t) => i(t)),
    ...
    getFixedT(t, e, s) {
      ...
      const n = function (t, e) {
        ...
        ((o.lng = o.lng || n.lng),
          (o.lngs = o.lngs || n.lngs),
          (o.ns = o.ns || n.ns),
          (o.keyPrefix = o.keyPrefix || s || n.keyPrefix));
        const u = i.options.keySeparator || '.';
        let h;
        return (
          (h =
            o.keyPrefix && Array.isArray(t)
              ? t.map((t) => `${o.keyPrefix}${u}${t}`)
              : o.keyPrefix
                ? `${o.keyPrefix}${u}${t}`
                : t),
          i.t(h, o)
      ...
      return (
        'string' == typeof t ? (n.lng = t) : (n.lngs = t),
        (n.ns = e),
        (n.keyPrefix = s),
        n
      );
    ...
    loadLanguages(t, e) {
      ...
      const i = this.options.preload || [],
        o = t.filter(
          (t) =>
            i.indexOf(t) < 0 && this.services.languageUtils.isSupportedCode(t),
        );
      return o.length
    ...
    dir(t) {
      if (
        ...
        return 'rtl';
      const e = (this.services && this.services.languageUtils) || new O(A());
      return [
        'ar',
        'shu',
        'sqr',
    ...
    cloneInstance() {
      ...
      return (
        ...
        s &&
          ((n.store = new v(this.store.data, i)),
          (n.services.resourceStore = n.store)),
        (n.translator = new S(n.services, i)),
        n.translator.on('*', function (t) {
          for (
            var e = arguments.length, s = new Array(e > 1 ? e - 1 : 0), i = 1;
            i < e;
            i++
