...
window.i18nResources['en'] = {
  translation: {
    ...
    quick_commands: {
      ...
      export_btn: 'Export',
      import_title: 'Import Commands',
      import_btn: 'Import',
      select_all: 'Select All',
      selected_count: 'Selected: {{selected}} / {{total}} commands',
      ungrouped: '(Ungrouped)',
      ...
      strategy_skip_all: 'Skip all duplicates',
      strategy_overwrite_all: 'Overwrite all duplicates',
      import_summary: 'New: {{new}}  Conflicts: {{conflicts}}  Skip: {{skip}}',
    },
